...
async function POST(req) {
    ...
    try {
        ...
        const ctx = await (0, route_auth_1.buildRouteContext)(req, db_1.db, "api:admin:overrides");
        ...
        const result = await (0, runtime_api_service_1.executeWithErrorHandling)(ctx, () => service.adminOverride(ctx, payload));
